...
#define APPLICATION_DEVICE_NAME         "Vermop"                         /**< BLE name displayed in scan response. */
#define APPLICATION_DEVICE_NAME_LENGTH  6                               /**< number of characters in above string, excluding null */
...
#define INIT_FWREV                      "1.1"                         /**< Original RuuviTag Vesion 2.5.9 Github tag. Github tag. Do not include specifiers such as "alpha" so you can accept ready binaries as they are **/
...
#define MAIN_LOOP_INTERVAL_RAW        1280u //Original was 1280u
#define ADVERTISING_INTERVAL_RAW      2010u //Original was 1280u //!< Apple guidelines Specify at most and exactly 1285 ms interval. Account for 0 - 10 ms random delay in advertisements
//#define MAIN_LOOP_INTERVAL_RAW_SLOW   ((5*1285)-5) // Apple maximum interval * 5
#define MAIN_LOOP_INTERVAL_RAW_SLOW   ((5*1285)-5) // Original was ((5*1285)-5) 
...
#define APPLICATION_ADVERTISEMENT_TYPE 0x00 // Initial was 0x03
